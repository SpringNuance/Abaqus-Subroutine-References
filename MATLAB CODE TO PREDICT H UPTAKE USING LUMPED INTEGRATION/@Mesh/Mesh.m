classdef Mesh < handle
    ...
    methods
        ...
        [Nodes, Egroups, Ngroups, Area, rect] = Geometry_Generator(obj, props);
        ...
        function obj = Mesh(inProps)
			...
			[obj.Nodes, obj.Elementgroups, obj.Nodegroups, obj.Area, rectangular] = obj.Geometry_Generator(inProps);
